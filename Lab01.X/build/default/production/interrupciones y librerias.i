# 1 "interrupciones y librerias.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "interrupciones y librerias.c" 2
...
void canal (char c);
char display_unidad( char unidad);
char display_decena(char decena);
# 26 "interrupciones y librerias.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\c90\\stdint.h" 1 3
# 27 "interrupciones y librerias.c" 2
